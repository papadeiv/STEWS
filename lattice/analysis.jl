...
lines!(ax, LinRange(0.57,0.68,length(variance[1:11000])), variance[1:11000].*1e5, linewidth = 2.0)
lines!(ax, 0.68.*ones(2), [1.28,3.25], color = :black, linestyle = :dash)
text!((0.525,3.00),text=L"\times 10^{-5}",fontsize=46)
save("../results/lattice/lung_ventilation/fig3.2.3.png", fig)
...
save("../results/lattice/lung_ventilation/fig3.2.1.png", fig)
...
lines!(ax, LinRange(0.5,1.2,length(detrended_signal)), detrended_signal.*1e3, linewidth = 2.0)
...
lines!(ax, LinRange(0.57,0.68,length(detrended_variance[1:11000])), detrended_variance[1:11000].*1e5, linewidth = 2.0)
#lines!(ax, 0.68.*ones(2), [1.28,3.25], color = :black, linestyle = :dash)
#text!((0.525,3.00),text=L"\times 10^{-5}",fontsize=46)
save("../results/lattice/lung_ventilation/fig3.2.4.png", fig)
