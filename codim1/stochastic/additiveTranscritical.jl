...
fig2 = Figure(; size = (800, 800), backgroundcolor = :transparent)
ax4 = Axis(fig2[1,1],
    # Background
    backgroundcolor = :transparent,
    xgridvisible = false,
...
# Export figures
save("../../results/fast_slow/fig2.6.3.png", fig1)
save("../../results/fast_slow/fig2.5.3.png", fig2)

# Plot an additional figure for the presentation
fig3 = Figure(; size = (1200, 400), backgroundcolor = :transparent)
ax = Axis(fig3[1,1],
    # Background
    backgroundcolor = :transparent,
    xgridvisible = false,
...
stable_neg = 0.0 .+ 0.0*y_neg
unstable_neg = 0.0 .+ 1.0*y_neg
lines!(ax, y_neg, stable_neg, color = :black, linewidth = 1.5)
lines!(ax, y_neg, unstable_neg, color = :black, linewidth = 1.5, linestyle = :dash)
lines!(ax, y_neg, stable_neg, color = :black, linewidth = 1.5)
lines!(ax, y_neg, unstable_neg, color = :black, linewidth = 1.5, linestyle = :dash)
save("../../results/fast_slow/slide6.3.png", fig3)
