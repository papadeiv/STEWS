...
Critical transitions are sudden and (often) unforeseen change of states occuring in many different natural and human complex systems.
...
The prediction of these events is, understandably, of great importance for many different applications. 
As a result, different scientific communities has been active in the detection of generic signs of early-warning (EWS) (e.g. [[Dakos 2008]](https://www.pnas.org/doi/10.1073/pnas.0802430105), [[Scheffer 2009]](https://www.nature.com/articles/nature08227) and [[Dakos 2012]](https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0041010)) which can help policymakers to predict the proximity of a dangerous collapse and make informed decision to prevent them [[Diekert 2025]](https://royalsocietypublishing.org/rsif/article/22/225/20240864/235940/Do-early-warning-signals-of-tipping-points-lead-to).
...
We introduce an EWS from a well-known framework in statistical mechanics that estimates the rate of escape of overdampled particles across potential energy barriers.
We show how this novel EWS has a direct interpretation in terms of the likelihood of a critical transition to occur in the near future, thereby providing direct insights to policymakers.
The EWS is computable from a single timeseries by using a simple linear least-squares regression, which we setup in the manuscript.
...
In `exp` you'll find many subdirs, each associated with an important experiment and/or a figure in the paper. The code in each subdir as follows
